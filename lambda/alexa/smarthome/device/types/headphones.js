...
const { VolumeLevel, MuteState, Playback, PlaybackStop, PowerState } = require('../attributes');

/**
 * Defines headphones device type class
 * @extends MobileDevice
 */
class Headphones extends MobileDevice {
  /**
  ...
  static get supportedAttributes() {
    return [VolumeLevel, MuteState, Playback, PlaybackStop, ...super.supportedAttributes];
  }
