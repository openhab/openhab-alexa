...
class AlexaDevice {
  ...
  getCapabilities(item, metadata) {
    ...
    for (const attribute of attributes) {
      capabilities.push(...(attribute.getCapabilities(item, metadata) || []));
    }
  ...
  static getDevice(value, groupType) {
    ...
    //  1) Specific device type and attribute (e.g. Light.PowerState)
    //  2) Specific device type and undefined attribute (e.g. Light)
