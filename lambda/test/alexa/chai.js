...
const ajv = new Ajv({ schemaId: 'auto', unknownFormats: ['double', 'int32'] });
// Add metadata for json schema draft v4 support
ajv.addMetaSchema(require('ajv/lib/refs/json-schema-draft-04.json'));
// Compile alexa schema
const validate = ajv.compile(require('./schemas/alexa_smart_home_message_schema.json'));
